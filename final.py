...
def run_inference(source, output,model_weights,cf,progress_callback=None):
    # Load the model
    #model_weights ="C:\\Users\\debas\\OneDrive\\Desktop\\VD_Streamlit-master\\best.pt"
    ...
    while cap.isOpened():
        ...
        for result in results:
            for box in result.boxes:
                ...
                if box.cls == 1 and confidence > cf:  # Only consider violence with confidence > 65%
